                    ...
                    <div class="card">
                        ...
                        <div class="card-body px-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-4" name="email_oder" required>
                            </div>
                            <div class="form-group">
                                <label for="email" class="">Họ và Tên</label>
                                <input type="text" class="form-control mb-4" name="name_oder" required>
                            </div>
                            <div class="form-group">
                                <label for="email" class="">Số điện thoại</label>
                                <input type="text" class="form-control mb-4" name="phone_oder" required>
                            </div>
                            <div class="form-group">
                                <label for="email" class="">Địa chị cụ thể: </label>
                                <input type="text" class="form-control mb-4" name="adr_oder" required>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="card-body px-4">
                        ...
                        <div class="form-check mt-3">
                            ...
                            <label class="form-check-label" for="payment3">
                                <img src="https://www.freepnglogos.com/uploads/qr-code-png/qr-code-file-bangla-mobile-code-0.png" width="15%" alt=""> Thanh toán qua chuyển khoản
                            </label>
                        </div>
                        <hr>
                        <div class="form-check mt-3">
