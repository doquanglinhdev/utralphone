                ...
                <div class="product-tab__contents">
                    <div class="product-tab__content product-tab__description">
                        ...
                        <div class="product-tab__inner">
                            ...
                            <form method="post" action="?ctr=login" id="customer_login" accept-charset="UTF-8" name="login" class="form form--main" style="display: block">
                            ...
                            <form method="post" action="/account/recover" id="recover_customer_password" accept-charset="UTF-8" name="recover" class="form form--main" style="display: none">
                                <input type="hidden" name="form_type" value="recover_customer_password" />
                                <input type="hidden" name="utf8" value="✓" />
                                ...
                                <button type="submit" class="form__submit button button--primary button--full">Khôi phục</button>
                                <div class="form__secondary-action">
